...
namespace NetCoreCqrs.Api.Tests.App_Infrastructure.ClassFixture
{
        ...
        : WebApplicationFactory<TStartup> where TStartup : class
    {
        ...
        protected override IHostBuilder CreateHostBuilder()
        {
            return Host.CreateDefaultBuilder()
                ...
                {
                    webBuilder.ConfigureAppConfiguration(builder => builder.AddJsonFile(new EmbeddedFileProvider(Assembly.GetExecutingAssembly()), "appsettings.Test.json", false, true));
